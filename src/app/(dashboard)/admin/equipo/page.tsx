...
import { Plus, Trash2, ArrowLeft, X, Save, Edit, Eye, EyeOff, Users, Instagram, Globe, GripVertical } from 'lucide-react'
...
export default function AdminEquipoPage() {
  ...
  const deleteMember = async (id: string) => {
    if (!confirm('¿Eliminar este miembro del equipo? Esta acción no se puede deshacer.')) return
    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-20 lg:pb-0">
      ...
      {members.length === 0 && (
        <div className="py-32 text-center border-2 border-dashed border-white/5 rounded-3xl">
          ...
          <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs mb-4">No hay miembros en el equipo</p>
          <p className="text-zinc-600 text-sm max-w-md mx-auto mb-6">
            Agrega barberos aquí para que aparezcan en la sección "Nuestro Equipo" del Home.
          </p>
