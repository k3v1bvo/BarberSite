          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-zinc-900 border border-white/10 p-6 rounded-2xl space-y-4">
                ...
                {/* Material PDF */}
                {selectedInduccion.pdf_url && (
                  <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-black text-white uppercase">Material Complementario PDF</p>
                        <p className="text-[10px] text-zinc-400">Guía y documentación oficial en PDF</p>
                      </div>
                    </div>
                    <a
                      href={selectedInduccion.pdf_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-lg transition shrink-0 flex items-center gap-1.5"
                    >
                      Abrir PDF ↗
                    </a>
                  </div>
